<?php
function SapphireRMS_URL_Partner_shortcode_handler() {
    $url = get_option('SapphireRMS_Options_url');
    $key = get_option('SapphireRMS_Options_key');
    return $url . '/web/partners/?id=' . $key;
}
?>
<?php
function SapphireRMS_partner_login_shortcode_handler() {
